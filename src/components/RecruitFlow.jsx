                      ...
                      {cards.map(candidate => (
                        <div key={candidate.id} draggable onDragStart={e => handleCardDragStart(e, candidate)} onDragEnd={() => { setDragCandidate(null); setDragOverStage(null) }}
                          ...
                          <div style={{ display: 'flex', gap: 3, flexWrap: 'wrap', alignItems: 'center' }}>
                            ...
                            {candidate.emp_type === 'intern' && <span style={{ padding: '1px 6px', borderRadius: 4, background: '#EEEAF4', color: '#6B5B95', fontSize: 9, fontWeight: 600 }}>Intern{candidate.class_year ? ' — ' + candidate.class_year : ''}</span>}
